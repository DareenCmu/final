<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        // update database
        $update_weight_score = $updatedata->update_table($course_no,$w1_1,$w1_2,$w1_3,$w1_4,$w1_5,$w1_6,$w1_7,$w2_1,$w2_2,$w2_3,$w2_4,$w2_5,$w2_6,$w2_7,$w2_8
        ,$w3_1,$w3_2,$w3_3,$w3_4,$w4_1,$w4_2,$w4_3,$w4_4,$w4_5,$w4_6,$w5_1,$w5_2,$w5_3,$w5_4,$total);

        $update_weight_score2 = $updatedata->changenull($course_no,$w1_1,$w1_2,$w1_3,$w1_4,$w1_5,$w1_6,$w1_7,$w2_1,$w2_2,$w2_3,$w2_4,$w2_5,$w2_6,$w2_7,$w2_8
        ,$w3_1,$w3_2,$w3_3,$w3_4,$w4_1,$w4_2,$w4_3,$w4_4,$w4_5,$w4_6,$w5_1,$w5_2,$w5_3,$w5_4);
       
        if ($update_weight_score && $update_weight_score2 ) {
...
<?php include 'navbar.php' ?>
    ...
    <div class="content-head">
        <h3>แก้ไขตารางวิชา <?php echo (int) $_GET['id']  ?></h3>
    </div>
