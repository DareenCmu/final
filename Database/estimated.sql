...
INSERT INTO `estimated` (`detail`)  VALUES ('สอบกลางภาค');
INSERT INTO `estimated` (`detail`)  VALUES ('สอบปลายภาค');
INSERT INTO `estimated` (`detail`)  VALUES ('สอบย่อย ');
INSERT INTO `estimated` (`detail`)  VALUES ('สอบปฏิบัติ');
INSERT INTO `estimated` (`detail`)  VALUES ('แบบฝึกหัด (ทฤษฎี)');
INSERT INTO `estimated` (`detail`)  VALUES ('แบบฝึกหัด (ปฏิบัติการ)');
INSERT INTO `estimated` (`detail`)  VALUES ('รายงาน');
INSERT INTO `estimated` (`detail`)  VALUES ('โครงงาน & สาธิต');
INSERT INTO `estimated` (`detail`)  VALUES ('การนำเสนอ');
INSERT INTO `estimated` (`detail`)  VALUES ('พฤติกรรมการมีส่วนร่วม');
INSERT INTO `estimated` (`detail`)  VALUES ('คะแนนเข้าชั้นเรียน ');
INSERT INTO `estimated` (`detail`)  VALUES ('วินัยการส่งงาน');
INSERT INTO `estimated` (`detail`)  VALUES ('อื่นๆ');
